...
const FIELD_LABELS = {
  ...
  brand: 'Brand', package_unit: 'Unità di misura', package_qty: 'Quantità per confezione', order: 'Ordine',
  ...
  product_cost: 'Costo prodotto', hourly_cost: 'Costo orario', discount_pct: 'Sconto %', purchase_discount_pct: 'Sconto',
  ...
  threshold: 'Soglia', min_threshold: 'Soglia minima', reward_value: 'Valore del premio', recipient_name: 'Destinataria',
